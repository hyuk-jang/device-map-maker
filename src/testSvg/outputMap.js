const map = {
  drawInfo: {
    frame: {
      mapSize: {width: 3000, height: 1230},
      svgModelResourceList: [
        {
          id: 'salternModuleBlock',
          type: 'rect',
          elementDrawInfo: {width: 240, height: 150, color: '#D1B2FF'},
        },
        {
          id: 'salternNomalBlock_A',
          type: 'rect',
          elementDrawInfo: {width: 240, height: 130, color: ''},
        },
        {
          id: 'salternNomalBlock_B',
          type: 'rect',
          elementDrawInfo: {width: 260, height: 180, color: ''},
        },
        {
          id: 'salternNomalBlock_C',
          type: 'rect',
          elementDrawInfo: {width: 300, height: 300, color: ''},
        },
        {
        ...
        },
        {
          id: 'brineWarehouse',
          type: 'rect',
          elementDrawInfo: {width: 170, height: 150, color: ''},
        },
        {
          id: 'waterDoor',
          type: 'rect',
          elementDrawInfo: {width: 55, height: 55, color: '#5F00FF'},
        },
        {id: 'sea', type: 'rect', elementDrawInfo: {width: 135, height: 120, color: ''}},
        {
          id: 'valve',
          type: 'polygon',
          elementDrawInfo: {width: 30, height: 30, color: '#9FC93C'},
        },
        {id: 'pipeLine', type: 'line', elementDrawInfo: {width: 170, height: 150, color: ''}},
        {
          id: 'outlet',
          type: 'circle',
          elementDrawInfo: {width: 30, height: 30, radius: 30, color: '#AEB404'},
        },
        {id: 'waterWay', type: 'line', elementDrawInfo: {width: 55, color: '#f06'}},
        {
          id: 'reservoir',
          type: 'rect',
          elementDrawInfo: {width: 550, height: 120, color: '#0100FF'},
        },
        {id: 'sea', type: 'rect', elementDrawInfo: {width: 170, height: 150, color: ''}},
        {
          id: 'pump',
          type: 'circle',
          elementDrawInfo: {width: 50, height: 50, radius: 50, color: '#f06'},
        },
      ],
    },
    positionList: {
      svgPlaceList: [
        {
          ...
          defList: [
            {id: 'SEB_1_A', resourceId: 'salternModuleBlock', position: [140, 950]},
            {id: 'SEB_1_B', resourceId: 'salternModuleBlock', position: [140, 760]},
            {id: 'SEB_1_C', resourceId: 'salternModuleBlock', position: [140, 570]},
            {id: 'SEB_1_D', resourceId: 'salternModuleBlock', position: [140, 380]},
            {id: 'SEB_1_E', resourceId: 'salternNomalBlock_C', position: [1000, 400]},
            {id: 'SEB_일반', resourceId: 'salternNomalBlock_A', position: [140, 210]},
            {id: 'SEB_2', resourceId: 'salternNomalBlock_B', position: [435, 340]},
            {id: 'SEB_3', resourceId: 'salternNomalBlock_B', position: [435, 532]},
            {id: 'SEB_4', resourceId: 'salternNomalBlock_B', position: [435, 727]},
            {id: 'SCB', resourceId: 'salternCrystalBlock', position: [435, 920]},
          ],
        },
        {
          target_id: 'brineWarehouse',
          defList: [
            {id: 'BW_1', resourceId: 'brineWarehouse', position: [400, 135]},
            {id: 'BW_2', resourceId: 'brineWarehouse', position: [590, 135]},
            {id: 'BW_3', resourceId: 'brineWarehouse', position: [780, 135]},
          ],
        },
        {
          target_id: 'reservoir',
          defList: [{id: 'RV', resourceId: 'reservoir', position: [400, 10]}],
        },
        {target_id: 'sea', defList: [{id: 'SEA', resourceId: 'sea', position: [825, 980]}]},
        {
          target_id: 'waterWay',
          defList: [
            {id: 'WW_001', resourceId: 'waterWay', position: [407.5, 1100, 407.5, 340]},
            {id: 'WW_002', resourceId: 'waterWay', position: [380, 312.5, 570, 312.5]},
            {id: 'WW_003', resourceId: 'waterWay', position: [722, 1100, 722, 340]},
            {id: 'WW_004', resourceId: 'waterWay', position: [570, 312.5, 835, 312.5]},
            {id: 'WW_005', resourceId: 'waterWay', position: [807.5, 340, 807.5, 1100]},
            {id: 'WW_006', resourceId: 'waterWay', position: [1027.5, 700, 1027.5, 1045]},
            {id: 'WW_007', resourceId: 'waterWay', position: [1055, 1072, 960, 1072]},
          ],
        },
        {
          target_id: 'pipeLine',
          defList: [
            {id: 'PL_001', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_002', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_003', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_004', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_005', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_006', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_007', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_008', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_009', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_010', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_011', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_012', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_013', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_014', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_015', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_016', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_017', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
            {id: 'PL_018', resourceId: 'pipeLine', position: [0, 0, 0, 0]},
          ],
        },
      ],
      svgNodeList: [
        {
          list: [
            {nodeId: 'MRT_006', point: false},
            {nodeId: 'MRT_005', point: false},
            {nodeId: 'WL_001', point: false},
            {nodeId: 'MRT_001', point: false},
            {nodeId: 'BT_001', point: false},
            {nodeId: 'WL_002', point: false},
            {nodeId: 'MRT_002', point: false},
            {nodeId: 'BT_002', point: false},
            {nodeId: 'WL_003', point: false},
            {nodeId: 'MRT_003', point: false},
            {nodeId: 'BT_003', point: false},
            {nodeId: 'WL_004', point: false},
            {nodeId: 'MRT_004', point: false},
            {nodeId: 'BT_004', point: false},
            {nodeId: 'S_001', point: false},
            {nodeId: 'S_002', point: false},
            {nodeId: 'S_003', point: false},
            {nodeId: 'WD_004', point: false},
          ],
        },
        {
          nodeClassId: 'waterDoor',
          list: [
            {nodeId: 'GV_001', resourceId: 'waterDoor', point: [325, 1001]},
            {nodeId: 'GV_002', resourceId: 'waterDoor', point: [325, 811]},
            {nodeId: 'GV_003', resourceId: 'waterDoor', point: [325, 621]},
            {nodeId: 'GV_004', resourceId: 'waterDoor', point: [325, 431]},
            {nodeId: 'GV_005', resourceId: 'waterDoor', point: [1000, 645]},
            {nodeId: 'WD_005', resourceId: 'waterDoor', point: [325, 285]},
            {nodeId: 'WD_006', resourceId: 'waterDoor', point: [435, 498]},
            {nodeId: 'WD_007', resourceId: 'waterDoor', point: [435, 690]},
            {nodeId: 'WD_008', resourceId: 'waterDoor', point: [640, 852]},
            {nodeId: 'WD_009', resourceId: 'waterDoor', point: [640, 1045]},
            {nodeId: 'WD_010', resourceId: 'waterDoor', point: [455, 230]},
            {nodeId: 'WD_011', resourceId: 'waterDoor', point: [645, 230]},
            {nodeId: 'WD_012', resourceId: 'waterDoor', point: [780, 230]},
            {nodeId: 'WD_013', resourceId: 'waterDoor', point: [380, 340]},
            {nodeId: 'WD_016', resourceId: 'waterDoor', point: [515, 285]},
            {nodeId: 'WD_014', resourceId: 'waterDoor', point: [694.5, 340]},
            {nodeId: 'WD_015', resourceId: 'waterDoor', point: [780, 340]},
          ],
        },
        {
          nodeClassId: 'valve',
          list: [
            {nodeId: 'V_001', resourceId: 'valve', point: [140, 950]},
            {nodeId: 'V_002', resourceId: 'valve', point: [140, 850]},
            {nodeId: 'V_003', resourceId: 'valve', point: [140, 570]},
            {nodeId: 'V_004', resourceId: 'valve', point: [140, 470]},
          ],
        },
        {
          nodeClassId: 'outlet',
          list: [
            {nodeId: 'O_001', resourceId: 'outlet', point: [155, 1010]},
            {nodeId: 'O_002', resourceId: 'outlet', point: [155, 820]},
            {nodeId: 'O_003', resourceId: 'outlet', point: [155, 630]},
            {nodeId: 'O_004', resourceId: 'outlet', point: [155, 440]},
            {nodeId: 'O_008', resourceId: 'outlet', point: [1060, 400]},
            {nodeId: 'O_005', resourceId: 'outlet', point: [599, 340]},
            {nodeId: 'O_006', resourceId: 'outlet', point: [665, 920]},
            {nodeId: 'O_007', resourceId: 'outlet', point: [920, 10]},
          ],
        },
        {
          nodeClassId: 'pump',
          list: [
            {nodeId: 'P_003', resourceId: 'pump', point: [400, 135]},
            {nodeId: 'P_004', resourceId: 'pump', point: [590, 135]},
            {nodeId: 'P_005', resourceId: 'pump', point: [900, 135]},
            {nodeId: 'P_002', resourceId: 'pump', point: [400, 10]},
            {nodeId: 'P_006', resourceId: 'pump', point: [900, 80]},
            {nodeId: 'P_001', resourceId: 'pump', point: [910, 980]},
          ],
        },
      ],
    },
        ...
        defList: [
          {
            ...
            nodeList: [
              ...
              {target_code: '006', data_logger_index: 0, axisScale: [0, 0], moveScale: [-4.5, 0]},
              {target_code: '007', data_logger_index: 0, axisScale: [0, 0], moveScale: [-4.5, 0]},
            ],
          },
          {
            target_id: 'gateValve',
  ...
  realtionInfo: {
    ...
    imgContactList: [
      ...
      {targetIdList: ['SEB_1_E'], resourceIdList: ['salternModuleBlock_C']},
