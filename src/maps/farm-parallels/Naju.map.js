    ...
    dataLoggerStructureList: [
      {
        ...
        dataLoggerDeviceList: [
          ...
          },
          {
            ...
            dccId: 'DCC_001',
            dpcId: 'DPC_001',
            nodeList: ['LX_002', 'CO2_002', 'WV_S_002', 'T_S_002', 'RH_S_002'],
          },
          {
            serial_number: 3,
            target_code: '003',
          ...
          },
          {
            ...
            dccId: 'DCC_001',
            dpcId: 'DPC_001',
            nodeList: ['LX_005', 'CO2_005', 'WV_S_005', 'T_S_005', 'RH_S_005'],
          },
          {
            serial_number: 6,
            target_code: '006',
        ...
        defList: [
          {
            ...
            placeList: [
              {
                target_code: '001',
                target_name: '고정식 쏠라테크',
                chart_color: '#212529',
                chart_sort_rank: 1,
                nodeList: ['kW_I_001', 'S_I_001'],
              },
              {
                target_code: '002',
                target_name: '고정식 LG',
