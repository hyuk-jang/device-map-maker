...
const map = {
  ...
  setInfo: {
    ...
    dccConstructorList: [
      ...
      {
        dccId: 'DCC_IVT_001',
        dccName: '육상 최종 G2G(다) 쏠라테크 인버터 로거',
        connect_info: {
          type: 'serial',
          subType: 'parser',
          baudRate: 9600,
      ...
      {
        dccId: 'DCC_IVT_002',
        dccName: '육상 최종 G2G(다) 에스케이쏠라 인버터 로거',
        connect_info: {
          type: 'serial',
          subType: 'parser',
          baudRate: 9600,
      ...
      {
        dccId: 'DCC_IVT_004',
        dccName: '수중 최종 G2G(단) 쏠라테크 인버터 로거',
        connect_info: {
          type: 'serial',
          subType: 'parser',
          baudRate: 9600,
      ...
      {
        dccId: 'DCC_IVT_005',
        dccName: '수중 최종 G2G(단) 에스케이쏠라 인버터 로거',
        connect_info: {
          type: 'serial',
          subType: 'parser',
          baudRate: 9600,
      ...
      {
        dccId: 'DCC_IVT_007',
        dccName: '수중 개선 G2G(단) 쏠라테크 인버터 로거',
        connect_info: {
          type: 'serial',
          subType: 'parser',
          baudRate: 9600,
    ...
    dpcConstructorList: [
      ...
      { dpcId: 'DPC_CNT_001', protocol_info: { mainCategory: 'Sensor', subCategory: 'dmTech' } },
    ],
    repeatNodeList: [
      {
      ...
      },
      {
        ...
        nodeList: [
          {
            target_code: '001',
            target_name: '현경 TB 육상',
          },
          {
            target_code: '002',
            target_name: '현경 TB 수중',
          },
        ],
      },
      {
